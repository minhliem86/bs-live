<div class="header">
  <div class="wrap-header">
    <a href="{!!route('front.getIndex')!!}" class="logo">
      <img src="{!!Request::segment(1) != '' ? asset('public/assets/frontend/images/logo-blue.png') : asset('public/assets/frontend/images/logo.png')!!}" class="img-responsive" alt="">
    </a>
...
<div class="overlay-menu overlay overlay-door">
  <nav>
    <ul class="main-navigation">
      ...
      <li><a href="{!!route('front.getRecent')!!}">Projects</a></li>
